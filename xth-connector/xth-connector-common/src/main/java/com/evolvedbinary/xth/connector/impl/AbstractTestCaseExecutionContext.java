...
public abstract class AbstractTestCaseExecutionContext implements TestCaseExecutionContext {

    private final TestSet testSet;
    private final TestCase testCase;
    private final Instant processingStarted;

    protected AbstractTestCaseExecutionContext(final TestSet testSet, final TestCase testCase, final Instant processingStarted) {
