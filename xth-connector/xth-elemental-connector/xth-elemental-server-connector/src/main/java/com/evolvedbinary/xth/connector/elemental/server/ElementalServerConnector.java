...
public class ElementalServerConnector extends AbstractConnector<ElementalServerTestCaseExecutionContext> {

    ElementalServerConnector(final Path baseUri, final EnumSet<SpecificationVersion> defaultSpecifications, final List<EnvironmentDefinition> globalEnvironments) {
    ...
    public List<Dependency<?>> supports(final List<Dependency<?>> dependencies) {
        return dependencies;  // TODO(AR) implement
    }
    ...
    @Override
    public ElementalServerTestCaseExecutionContext prepareTestCaseForExecution(final TestSet testSet, final TestCase testCase) throws ConnectorException {
        throw new ConnectorException(new UnsupportedOperationException("TODO(AR) implement"));
    }

    @Override
    public TestCaseResult executeTestCase(final ElementalServerTestCaseExecutionContext testCaseExecutionContext) {
        throw new UnsupportedOperationException("TODO(AR) implement");
    }
}
