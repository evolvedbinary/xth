...
public class ElementalEmbeddedTestCaseExecutionContext extends AbstractCompiledTestCaseExecutionContext {
    ElementalEmbeddedTestCaseExecutionContext(final TestSet testSet, final TestCase testCase, final Instant processingStarted, final Instant compilationStarted, final Instant compilationFinished) {
