...
public class ElementalEmbeddedConnectorFactoryProvider implements ConnectorFactoryProvider {
    @Override
    public ConnectorFactory newConnectorFactory() {
        return new ElementalEmbeddedConnectorFactory();
    }
}
