...
public class OtrReporter implements Reporter {

    private final ReporterConfiguration reporterConfiguration;

    OtrReporter(final ReporterConfiguration reporterConfiguration) {
        this.reporterConfiguration = reporterConfiguration;
    }

    @Override
    public String getReporterName() {
        return "Open Test Reporting Reporter";
    }

    @Override
    public TestResultsListener open() throws ReporterException {
        try {
            return OtrTestResultsListener.open(reporterConfiguration);
