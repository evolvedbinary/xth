...
public class PrintStreamReporterProvider implements ReporterProvider {
    @Override
    public Reporter newReporter(final ReporterConfiguration reporterConfiguration) {
        return new PrintStreamReporter(reporterConfiguration);
    }
}
