...
public class PrintStreamReporter implements Reporter {
    ...
    PrintStreamReporter(final ReporterConfiguration reporterConfiguration) {
        this.reporterConfiguration = reporterConfiguration;
    }

    @Override
    public String getReporterName() {
        return "PrintStream Reporter";
    }

    @Override
    public TestResultsListener open() {
        return PrintStreamTestResultsListener.open(reporterConfiguration);
    }
}
