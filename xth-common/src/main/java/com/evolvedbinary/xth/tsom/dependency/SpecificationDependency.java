...
public sealed interface SpecificationDependency extends Dependency<Set<SpecificationVersionDescription>> permits SpecificationDependencyImpl {
    ...
    /**
     * Determines if this Specification Dependency is compatible
     * with another Specification Dependency.
     *
     * @param otherSpecificationDependency the other specification dependency to compare against.
     *
     * @return true if the two Specification Dependencys are compatible.
     */
    boolean isCompatibleWith(SpecificationDependency otherSpecificationDependency);
}
