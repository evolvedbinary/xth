...
public class NamedEnvironmentImpl extends AbstractEnvironment implements Environment, NamedEnvironment {
    ...
    private NamedEnvironmentImpl(final String name, final List<Schema> schemas, final List<Source> sources,
                                 final List<Resource> resources, final List<Parameter> parameters,
                                 final @Nullable ContextItem contextItem, final List<DecimalFormat> decimalFormats,
                                 final List<Namespace> namespaces, final List<FunctionLibrary> functionLibraries,
                                 final List<Collection> collections, final @Nullable StaticBaseUri staticBaseUri,
                                 final @Nullable Collation collation) {
