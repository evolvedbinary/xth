...
public sealed interface TestCase permits TestCaseImpl {
    ...
    interface Builder {
        ...
        Builder setCreated(Created created);
        Builder addModified(Modified modified);
        Builder addEnvironment(Environment environment);
        Builder addModule(Module module);
        Builder addDependency(Dependency<?> dependency);
        Builder setTest(Test test);
        Builder setResult(Assertion assertion);
        TestCase build();
    }
}
